...
img_sizes = [(256, 320), (256, 480), (256, 640), (384, 640),
             (480, 640), (640, 640), (736, 1280)]

for num, img_size in enumerate(img_sizes):
    print("Processing", img_size)
    w = f"/models/pinto/yolov7-tiny_post_{img_size[0]}x{img_size[1]}.onnx"
    ...
    image = img.copy()
    image, ratio, dwdh = letterbox(image, new_shape=(
        img_size[0], img_size[1]), auto=False)
